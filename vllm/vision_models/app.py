...
vllm_image = Image(python_version="python3.10", python_packages=["vllm==0.6.3.post1", "fastapi[standard]==0.115.4", "huggingface_hub[hf-transfer]"]).with_envs("HF_HUB_ENABLE_HF_TRANSFER=1")
